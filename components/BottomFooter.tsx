    ...
    >
      <div className="mx-auto text-center  md:max-w-[58rem]">
        ...
        <div className="flex w-full flex-wrap items-center justify-center gap-2 pt-5 text-xs font-medium text-gray-600 dark:text-gray-400">
          <Link
            href={"https://www.ayesoul.com/terms"}
            scroll={true}
            target="_blank"
            onClick={onClickLinkMain}
          >
            Terms
          </Link>
          •
          <Link
            href={"https://www.ayesoul.com/privacy"}
            scroll={true}
            target="_blank"
            onClick={onClickLinkMain}
          >
          ...
          •
          <Link
            href={"https://www.ayesoul.com/contact"}
            scroll={true}
            target="_blank"
            onClick={onClickLinkMain}
          >
        ...
        <p className="mt-3 text-xs leading-7 text-gray-500  ">
          ...
          <Link href={"https://www.rajsavaliya.com/"} target="_blank">
            CahiTea.Chat from SRX9
          </Link>
        </p>
      </div>
    </div>
